...
<ul class="bg-bubbles">
    ...
    <div class="bg gb-blur" style="display: none"></div>
        ...
        methods:{
                        ...
                        requestLogin(loginParams).then(data=>{
                            ...
                            if(!data.success){
                               ...
                               // console.log(data);
                                ...
                                var expiredate=new Date(curTime.setSeconds(curTime.getMinutes()+data.expires_in));
            ...
            getUserInfoByToken(token){
               ...
               getUserByToken(loginParams).then(data=>{
                   if(!data.success){
                       ...
                       _this.loginStr="接受用户数据,开始初始化路由树..";
            ...
            GetNavigationBar(uid){
                ...
                getNavigationBar(loginParams).then(data=>{
                    _this.logining=false;
                    console.log('GetNavigationBar',data);
                    if(!data.success){
                        _this.$message({
                            message:data.message,
                            type:'error'
